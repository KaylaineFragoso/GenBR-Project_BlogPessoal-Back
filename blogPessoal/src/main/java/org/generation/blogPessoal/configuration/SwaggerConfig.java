	...
	public OpenAPI springOpenAPI() {
		return new OpenAPI()
				.info(new Info()
						...
						.contact(new Contact()
								.name("Github KaylaineFragoso")
								.url("https://github.com/KaylaineFragoso")
								.email("kaylainefragoso@gmail.com")))
				.externalDocs(new ExternalDocumentation()
						.description("Github")
						.url("https://github.com/KaylaineFragoso/GenBR-Project_BlogPessoal-Back"));
